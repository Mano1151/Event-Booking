...
const (
	...
	UserService_LoginUser_FullMethodName  = "/users.v1.UserService/LoginUser"
)
...
type UserServiceClient interface {
	...
	LoginUser(ctx context.Context, in *LoginUserRequest, opts ...grpc.CallOption) (*AuthReply, error)
}
...
func (c *userServiceClient) LoginUser(ctx context.Context, in *LoginUserRequest, opts ...grpc.CallOption) (*AuthReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthReply)
...
func (UnimplementedUserServiceServer) CreateUser(context.Context, *CreateUserRequest) (*UserReply, error) {
...
func (UnimplementedUserServiceServer) LoginUser(context.Context, *LoginUserRequest) (*AuthReply, error) {
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "userservice/v1/users.proto",
}
