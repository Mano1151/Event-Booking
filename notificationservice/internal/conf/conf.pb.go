...
type Bootstrap struct {
	...
	Email         *Email                 `protobuf:"bytes,3,opt,name=email,proto3" json:"email,omitempty"` // add this
...
// Add this message for Email config
type Email struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\x05email\x18\x03 \x01(\v2\x11.kratos.api.EmailR\x05email\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"\x8d\x01\n" +
	"\x05Email\x12\x1b\n" +
	...
	"\x04from\x18\x05 \x01(\tR\x04fromB(Z&notificationservice/internal/conf;confb\x06proto3"
